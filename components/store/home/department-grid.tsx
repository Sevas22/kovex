        ...
        {departments.map((d) => (
          <li key={d.slug}>
            <Link
              ...
              className="group relative flex h-full flex-col overflow-hidden rounded-md border bg-white transition-colors hover:border-brand-blue"
            >
              {/* Esquina azul a 45°: el brazo superior del monograma */}
              <span
                className="absolute top-0 right-0 z-10 size-7 bg-brand-blue [clip-path:polygon(0_0,100%_0,100%_100%)]"
                aria-hidden="true"
              />
