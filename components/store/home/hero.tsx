    ...
    <section className="relative overflow-hidden bg-brand-mist">
      <div className="mx-auto max-w-7xl px-4">
        <div className="relative z-10 flex flex-col gap-6 py-12 md:py-16 lg:w-[46%] lg:py-28">
          <h1 className="font-display text-[1.7rem] leading-[1.2] text-brand-navy uppercase sm:text-4xl xl:text-[2.75rem]">
            Soluciones <span className="text-brand-blue">mayoristas</span> para tu negocio
          </h1>
          ...
          <div className="flex flex-wrap gap-3">
            <Button size="xl" className="chamfer pr-7" nativeButton={false} render={<Link href="/catalogo" />}>
              Ver catálogo
